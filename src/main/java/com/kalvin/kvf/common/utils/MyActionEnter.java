...
public class MyActionEnter {
    ...
    public MyActionEnter(HttpServletRequest request, String rootPath, String configPath) {
        this(new MyStorageManager(), request, rootPath, configPath);
    }

    public MyActionEnter(IStorageManager storage, HttpServletRequest request, String rootPath) {
        this(storage, request, rootPath, (String)null);
    }

    public MyActionEnter(IStorageManager storage, HttpServletRequest request, String rootPath, String configPath) {
        this.request = null;
        this.rootPath = null;
        ...
        this.configManager = MyConfigManager.getInstance(this.rootPath, this.contextPath, configPath);
    }
